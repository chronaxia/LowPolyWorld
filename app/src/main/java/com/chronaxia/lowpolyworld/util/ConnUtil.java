...
public class ConnUtil {
     ...
     * @throws MyException
     */
    public static String getResponseString(HttpURLConnection conn) throws IOException, MyException {
     ...
     * @throws MyException http 的状态码不是 200
     */
    public static byte[] getResponseBytes(HttpURLConnection conn) throws IOException, MyException {
        ...
        if (responseCode != 200) {
            ...
            throw new MyException("http response code is" + responseCode);
        }
