...
public class LowPoly {
    ...
    public static void createLowPoly(Context context, Bitmap bitmapIn, int accuracy, int flag, Callback callback) {
        mBitmapIn = bitmapIn;
        RENDERED_FLAG = flag;
        ...
        createLowPolyScript(context, accuracy, bitmapIn, bitmapOut, callback);
